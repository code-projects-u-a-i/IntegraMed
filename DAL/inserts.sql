...
GO
INSERT [dbo].[Usuario] ([Usuario_ID], [Usuario_Username], [Usuario_Password], [Usuario_Mail], [Usuario_IntentosFallidos], [Usuario_Bloqueado], [DVH]) VALUES (1, N'test', N'098f6bcd4621d373cade4e832627b4f6', NULL, CAST(0 AS Numeric(18, 0)), 0, NULL)
GO
INSERT [dbo].[Usuario] ([Usuario_ID], [Usuario_Username], [Usuario_Password], [Usuario_Mail], [Usuario_IntentosFallidos], [Usuario_Bloqueado], [DVH]) VALUES (2, N'prueba', N'c893bad68927b457dbed39460e6afd62', NULL, CAST(0 AS Numeric(18, 0)), 0, NULL)
GO
INSERT [dbo].[Usuario] ([Usuario_ID], [Usuario_Username], [Usuario_Password], [Usuario_Mail], [Usuario_IntentosFallidos], [Usuario_Bloqueado], [DVH]) VALUES (3, N'rr', N'514f1b439f404f86f77090fa9edc96ce', NULL, CAST(0 AS Numeric(18, 0)), 0, NULL)
GO
INSERT [dbo].[Usuario] ([Usuario_ID], [Usuario_Username], [Usuario_Password], [Usuario_Mail], [Usuario_IntentosFallidos], [Usuario_Bloqueado], [DVH]) VALUES (4, N'nuevo', N'e26c062fedf6b32834e4de93f9c8b644', NULL, CAST(0 AS Numeric(18, 0)), 0, NULL)
GO
INSERT [dbo].[Usuario] ([Usuario_ID], [Usuario_Username], [Usuario_Password], [Usuario_Mail], [Usuario_IntentosFallidos], [Usuario_Bloqueado], [DVH]) VALUES (5, N'admin', N'21232f297a57a5a743894a0e4a801fc3', N'admin@admin.com', CAST(0 AS Numeric(18, 0)), 0, NULL)
GO
INSERT [dbo].[Usuario] ([Usuario_ID], [Usuario_Username], [Usuario_Password], [Usuario_Mail], [Usuario_IntentosFallidos], [Usuario_Bloqueado], [DVH]) VALUES (7, N'gerente', N'740d9c49b11f3ada7b9112614a54be41', N'gerente@gerente.com', CAST(0 AS Numeric(18, 0)), 0, NULL)
GO
INSERT [dbo].[Usuario] ([Usuario_ID], [Usuario_Username], [Usuario_Password], [Usuario_Mail], [Usuario_IntentosFallidos], [Usuario_Bloqueado], [DVH]) VALUES (8, N'user', N'ee11cbb19052e40b07aac0ca060c23ee', N'user@user.com', CAST(0 AS Numeric(18, 0)), 0, NULL)
GO
